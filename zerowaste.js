...
function addCart(number) {
    ...
    document.getElementById('products').innerHTML += '<div class="input-group mb-1">' +
    '<span class="form-control border-0">' + newname + ' (' + newproduct + '€)' + '</span>' + 
    '<button class="btn btn-danger eu" btn-sm input-group-text"><i class="fa fa-trash-o"></i></button>' +
    '</div>';
